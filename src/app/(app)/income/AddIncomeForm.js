...
// Import the action and frequencies
import { addIncomeSource, INCOME_FREQUENCIES } from '@/app/(app)/income/actions';
...
export default function AddIncomeForm({ onClose }) {
    ...
    return (
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            {(isRecurring || frequency === 'once') && ( // Show for recurring OR if 'once' is selected (to allow optional date)
                 <div>
